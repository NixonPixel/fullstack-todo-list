...
const TodoItem = ({ text, userName, createdAt, classes, id, setDoneTodo, accessDenied, changeTodoText, changeTodo, todoName }) => {
    ...
    return (
        <div className={classes.container}>
            <div className={classes.head}>
                ...
                <Typography variant="h6">Задача:{todoName}</Typography>
            ...
            <div className={classes.body}>
                ...
                {accessDenied 
                ? <Typography style={{wordBreak: 'break-word'}}>Описание: {todoText}</Typography> 
                : <React.Fragment>
